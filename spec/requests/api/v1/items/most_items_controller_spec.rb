...
RSpec.describe Api::V1::Items::MostItemsController do
  describe "GET #index" do
    ...
    it "outputs data for x items with the highest number of items sold" do
      get "/api/v1/items/most_items?quantity=2"
      ...
      expected_first =  {
        ...
        "attributes" => {
          "id" => @it31.id,
          "name" => @it31.name,
          "description" => @it31.description,
          "unit_price" => format_price(@it31.unit_price),
          "merchant_id" => @it31.merchant_id
        }
      }
